...
*/
    //pokud se fronta neinicializovala
    if(q == NULL){
        queueError(QERR_INIT);
        return;
    }
...
*/
    ...
    //posun o 1
    //pokud preteče jde na 0
    //tím zajištěna kruhovost
...
*/
    ...
    //ukazatel začátku se rovná ukazateli na konec
...
*/
    ...
    //fronta je plná pokud
    //následník posledního se rovná prvnímu
...
*/
    ...
    //ošetření chyby
    //nelze volat pokud je fronta prázdná
    if(queueEmpty(q) != 0){
        queueError(QERR_FRONT);
    }
    else
    {
        // argument na který ukazuje začátek
        *c = q->arr[q->f_index];
    }
...
*/
    ...
    if(queueEmpty(q) != 0){
        ...
        /*
        ** posun ukazatele na začátek
        ** vrchní hodnotu nemažeme, je jedno jaká je
        ** protože se kní už stejně nedostaneme
        */
