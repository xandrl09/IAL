...
**/
	...
	//nestavime binarni strom na null
	* RootPtr = NULL;
...
**/
    ...
    {
        if(RootPtr->Key == K)
        // kdyz najde uzel s hledanym klicem
        {
...
**/
	...
	{
	    //vytvorime koren
        tBSTNodePtr pomoc = malloc(sizeof(struct tBSTNode));
        if(pomoc != NULL)
        {
            //nahrani dat
            pomoc->BSTNodeCont = Content;
            //v levo  nic
            pomoc->LPtr = NULL;
            //v pravo  nic
            pomoc->RPtr = NULL;
        ...
        if((*RootPtr)->Key == K)
        {
            ...
            if(PoM->LPtr == NULL)
            {
                ...
                *RootPtr = PoM->RPtr;
                ...
                //ma jen levy podstrom
            else if(PoM->RPtr == NULL)
            {
                //zdedi ho otec
                *RootPtr = PoM->LPtr;
                free(PoM);
            }
                //ma oba podstromy, nahradime najpravejsim
            else
            {
